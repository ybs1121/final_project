...
public class DetailNoticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rename_text =  findViewById(R.id.textView7);
        rename_text.setText("발견일자");

       // Toast.makeText(DetailNoticeActivity.this, num, Toast.LENGTH_SHORT).show();
        ...
        del_Dialog = new Dialog(DetailNoticeActivity.this);
                ...
                send.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (passwd.equals(temp_passwd)==true){
                            ...
                            Toast myToast = Toast.makeText(DetailNoticeActivity.this,"비밀번호 불일치" , Toast.LENGTH_SHORT);
                            myToast.show();
    ...
    class del_BackgrounTask extends AsyncTask<Void, Void, String> {
        ...
        @Override
        protected void onPreExecute() {
            target = "http://" + Sever_ip + "/del_test.php";
            ...
            try {
                ...
                while (count != 1) {
                    ...
                    if(i_sc.equals(sc)){
                        ...
                        count = 1;
                        Toast myToast = Toast.makeText(DetailNoticeActivity.this,"삭제실패" , Toast.LENGTH_SHORT);
                        myToast.show();
