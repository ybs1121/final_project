...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(text_id.equals("")){
            ...
            Toast myToast = Toast.makeText(MainActivity.this,"자동 로그인" , Toast.LENGTH_SHORT);
            myToast.show();
            login.setText("로그아웃");
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent open = new Intent(getApplicationContext(),InsertActivity.class);
                startActivity(open);
        ...
        try{
            ...
            if((str_msg=msg.getStringExtra("message")) != null){
                Toast myToast = Toast.makeText(MainActivity.this,str_msg , Toast.LENGTH_SHORT);
                myToast.show();
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                search_Dialog = new Dialog(MainActivity.this);
