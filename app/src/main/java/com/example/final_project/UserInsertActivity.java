...
public class UserInsertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dog_cat.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(checkedId == R.id.radioButton){
                    result = "강아지";
                    kind = 1;
                    Toast myToast = Toast.makeText(UserInsertActivity.this,"강아지" , Toast.LENGTH_SHORT);
                    myToast.show();
                }else{
                    result = "고양이";
                    kind = 0;
                    System.out.println(result);
                    Toast myToast = Toast.makeText(UserInsertActivity.this,"고양이" , Toast.LENGTH_SHORT);
                    myToast.show();
                }
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast myToast = Toast.makeText(UserInsertActivity.this,area_text , Toast.LENGTH_SHORT);


                if (TextUtils.isEmpty(password.getText()) || TextUtils.isEmpty(area.getText())){
                    myToast = Toast.makeText(UserInsertActivity.this,"저장준비실패" , Toast.LENGTH_SHORT);
                    myToast.show();

                }
                else {
                    myToast = Toast.makeText(UserInsertActivity.this,area_text , Toast.LENGTH_SHORT);
                    myToast.show();
                }
    ...
    public String getImagePathToUri(Uri data) {
        ...
        Toast.makeText(UserInsertActivity.this, "이미지 이름 : " + imgName, Toast.LENGTH_SHORT).show();
    ...
    private class Connect extends AsyncTask< String , String,Void > {
        ...
        protected void onProgressUpdate(String... params){
            ...
            if(params[0].equals("fail")){
                Toast myToast = Toast.makeText(UserInsertActivity.this,"파이썬 서버 에러" , Toast.LENGTH_SHORT);
                myToast.show();
